...
export const projects = [
  {
    ...
    technologies: [".NET", "Angular", "Material","SQL-SERVER", "Entity Framework", "Heroku" , "BackBlaze Buckets","SignalR (Websocket)"],
    links: [
      {
        svg: svgs.github,
        redirect: "https://github.com/adeldueast/GarderieManagement.CleanArchitechture",
      },
      {
        svg: svgs.github,
      ...
      {
        svg: svgs.deployed,
        redirect: "https://childcare-management-demo.netlify.app/login?returnUrl=%2F",
      },
    ],
  ...
  },
  {
    ...
    description: (<p>A minimal windows form application that controls weapon’s recoil with a 1ms precision. 
    It includes customizable features as custom keybinds and custom configuration to make it look realistic. Unify is also very lightweight 
    as it takes less than 1% cpu usage. 
    <br /><span>*Educational purposes only*</span> </p>),
  ...
  },
  {
    ...
    description:
      (<p>
        A web app for keeping track of your favorite artists on Spotify. View all their albums, tracks, incoming concerts 
         and play any tracks audio sample.
      </p>),
    ...
    links: [
      {
        svg: svgs.github,
        redirect: "https://github.com/adeldueast/Super-Musique-Infinie-Spotify-API",
      },
    ],
    featuredTitle: '',
  },
